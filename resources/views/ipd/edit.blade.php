                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('ipd.update', 'base64_encode($data->ipd_id)') }}" id="createCatefgory">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pa_id" id="ap_pa_search" class="form-control">
                                                        ...
                                                        <option value="{{ $list->pa_id }}" {{ ($data->pa_id == $list->pa_id) ? 'selected' : '' }}>{{ $list->pa_name }} - {{ $list->pa_id }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="ipd_doctor" id="ap_doctor_search">
                                                        ...
                                                        <option value="{{$doctor['user_id'] }}" {{ ($data->ipd_doctor == $doctor['user_id']) ? 'selected' : '' }}>{{ $doctor['person_name'] }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="rm_id" id="rm_id_search">
                                                        ...
                                                        <option value="{{$room->rm_id }}" {{ ($data->rm_id == $room->rm_id) ? 'selected' : '' }}>{{ $room->rm_building.'-'.$room->rm_floor.'-'.$room->rm_ward.'-'.$room->rm_no }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="Date of Admit" name="ipd_admit_date" id="ipd_admit_date" value="{{ $data->ipd_admit_date }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="Date of Surgery" name="ipd_surgery_date" id="ipd_surgery_date" value="{{ $data->ipd_surgery_date }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Type of Surgery" name="ipd_surgery_text" id="ipd_surgery_text" value="{{ $data->ipd_surgery_text }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <!--begin: Code-->
    ...
    $("form").submit(function(e) {
        ...
        if(pa_id == ''){
            ...
            $.ajax({
                ...
                url:"{{ route('ipd.update', base64_encode($data->ipd_id)) }}",
                method:"POST",
