                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <form method="POST" action="{{ route('general-medicine.store') }}" id="createCatefgory">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Medicine Name" name="gm_name" id="gm_name" />
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="gm_description" id="gm_description" class="form-control" cols="30" rows="10"></textarea>
                                                    <span class="text-danger" id="gm_company_nameErr"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('general-medicine.list') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </form>
                                <!--end::Form-->
                            </div>
    ...
    $("form").submit(function(e) {
        ...
        if(gm_name == ''){
            ...
            $.ajax({
                ...
                url:"{{ route('general-medicine.store') }}",
                method:"POST",
