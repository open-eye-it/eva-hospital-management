...
@section('title', 'Operation Medicine - Create')
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('operation-medicine.update', $data->om_id) }}" id="createCatefgory">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Medicine Name" name="om_name" id="om_name" value="{{ $data->om_name }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Company Name" name="om_company_name" id="om_company_name" value="{{ $data->om_company_name }}" />
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="om_description" id="om_description" class="form-control" cols="30" rows="10">{{ $data->om_description }}</textarea>
                                                    <span class="text-danger" id="om_company_nameErr"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('operation-medicine.list') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </form>
                                <!--end::Form-->
                            </div>
    ...
    $("form").submit(function(e) {
        ...
        if(om_name == ''){
            ...
            $.ajax({
                ...
                url:"{{ route('operation-medicine.update', base64_encode($data->om_id)) }}",
                method:"POST",
