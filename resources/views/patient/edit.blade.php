                                ...
                                <form method="POST" enctype="multipart/form-data" action="{{ route('referred-doctor.store') }}" id="createCatefgory">
                                    ...
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" placeholder="Contact No" name="pa_contact_no" id="pa_contact_no" value="{{ $data->pa_contact_no }}" />
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" placeholder="Alternate Contact No" name="pa_alt_contact_no" id="pa_alt_contact_no" value="{{ $data->pa_alt_contact_no }}" />
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Pan Card" name="pa_pan_card" id="pa_pan_card" value="{{ $data->pa_pan_card }}" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-4 col-12">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 {{ $data->pa_referred_by != 'doctor' ? 'd-none' : '' }}" id="pa_referred_doctor_box">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-12 {{ $data->pa_referred_by != 'other' ? 'd-none' : '' }}" id="pa_referred_text_box">
                                                <div class="form-group">
...
<script>
    ...
    const iti = window.intlTelInput(input, {
        initialCountry: "{{ $data->pa_country_code }}",
    ...
    const iti1 = window.intlTelInput(input1, {
        initialCountry: "{{ $data->pa_alt_country_code }}",
        loadUtils: () => import("https://cdn.jsdelivr.net/npm/intl-tel-input@25.2.1/build/js/utils.js"),
        hiddenInput: (telInputName) => ({
