                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Ward" name="rm_ward" id="rm_ward" value="{{ $data->rm_ward }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Room No" name="rm_no" id="rm_no" value="{{ $data->rm_no }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Room Charge" name="rm_charge" id="rm_charge" value="{{ $data->rm_charge }}" />
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="rm_busy" id="rm_busy" class="form-control">
                                                        ...
                                                        <option value="1" {{ ($data->rm_busy == 1) ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ ($data->rm_busy == 0) ? 'selected' : '' }}>No</option>
                                                    </select>
    ...
    $("form").submit(function(e) {
        ...
        if(rm_building == ''){
            ...
            $.ajax({
                ...
                url:"{{ route('room.update', base64_encode($data->rm_id)) }}",
                method:"POST",
